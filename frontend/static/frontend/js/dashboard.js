var Dashboard = function () {
    var e = function (e, t, a, r) {
        ...
        , t = function () {
            var e = function () {
                if (0 != $("#m_chart_personal_income_quater_12").length) {
                    var e = new Chartist.Pie("#m_chart_personal_income_quater_21", {
                        series: [{
                            value: 50,
                            className: "custom",
                            meta: {
    ...
    return {
        init: function () {
            ...
            !function () {
                ...
                $(document).on("click", ".comm-car-menu", function () {
                ...
                b = $(".tp-menu"),
                s = $("#m_widget_body_owlcarousel_items_tp"),
                b.children().each(function (e) {
                    $(this).attr("data-position", e)
                }),
                s.owlCarousel({
                    rtl: mUtil.isRTL(),
                ...
                $(document).on("click", ".tp-car-item", function () {
                   b.trigger("to.owl.carousel", $(this).data("position"))
                })
